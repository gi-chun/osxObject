...
function ComDownloadSubmit(opt_formId) {
...
function ComSubmitOriginal(opt_formId) {
	this.formId = gfn_isNull(opt_formId) == true ? "commonForm" : opt_formId;
	this.url = "";
...
function ComSubmit(opt_formId, opt_devId) {
	this.formId = gfn_isNull(opt_formId) == true ? "commonForm" : opt_formId;
	this.url = "";
	...
	this.addParam = function addParam(key, value){
		$("#"+opt_devId).append($("<input type='hidden' name='"+key+"' id='"+key+"' value='"+value+"' >"));
	};
