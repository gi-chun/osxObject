       ...
       <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1 id="homeHeading">Performance Status</h1>
        ...
        <aside class="bg-dark">
            <div class="container text-center">
                <div class="header-content-inner">
                    ...
                    <a id="id_show_budgetInfo" class="btn btn-primary btn-xl page-scroll">예산정보 보기</a>
...
// 			    		console.log("i:"+i+"item:"+ $.trim($(item).html())); 
		...
		function fn_getSessionCallback(data){
        	...
        	//test
//         	team_db_name = "관리팀";
//         	goCommand = "createBudget";
        	
//         	g_project_number = "5";
//         	g_project_name = "프로젝트1";
//         	g_product_team = "연출2팀";
//         	g_charge_pm = "ㄴㅇㄹ";
//         	g_charge_pd = "ㄴㅇㄹ";
//         	g_contract_amount = "1000000000";
//         	g_product_amount = "100000000";
        	...
        	if(goCommand == "createBudget"){
        		fn_setSessionGoCommand();
        		
        		$('#cbFormPrjName').val(g_project_name);
        		$('#cbFormCteam').val(g_product_team);
        		$('#cbFormPM').val(g_charge_pm);
        		$('#cbFormPD').val(g_charge_pd);
        		$('#cbFormContractAmount').val(g_contract_amount);
        		$('#cbFormProductAmount').val(g_product_amount);
...
//                 cpFormDeliveryProduct = cpFormDeliveryProduct.replace(/\s+/g, '');
			...
			function fn_insertProject_Callback(data){
	        	...
	        	if(!success){
	        		...
	        		var comSubmit = new ComSubmit("frmCreateProject");
...
//	                 cpFormDeliveryProduct = cpFormDeliveryProduct.replace(/\s+/g, '');
	        ...
	        function fn_downloadFile(obj){
				...
				comSubmit.setUrl("<c:url value='/common/downloadProjectFile.do' />");
				comSubmit.addParam("storage_file_name", storage_file_name);
				comSubmit.submit();
			}
