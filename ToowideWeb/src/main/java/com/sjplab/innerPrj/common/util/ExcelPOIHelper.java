...
//              .forEach(i -> ls.add(new MyCell("")));
    ...
    private String readCellContent(Cell cell) {
        ...
        case NUMERIC:
            if (DateUtil.isCellDateFormatted(cell)) {
            	...
            	content = (int) Math.round(cell.getNumericCellValue()) + "";
            }
            break;
        case BOOLEAN:
    ...
    private Map<Integer, List<String>> readHSSFWorkbook(FileInputStream fis) throws IOException {
        Map<Integer, List<String>> data = new HashMap<>();
...
//                                .add(new MyCell(""));
    ...
    private Map<Integer, List<String>> readXSSFWorkbook(FileInputStream fis) throws IOException {
