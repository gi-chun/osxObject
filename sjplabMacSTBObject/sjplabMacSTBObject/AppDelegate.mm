...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    if(![[NSUserDefaults standardUserDefaults] integerForKey:cfirstAppExe]){
        ...
        [[NSUserDefaults standardUserDefaults] setInteger:1 forKey:cdisplay_optionNo]; // ? 1280*720
        [[NSUserDefaults standardUserDefaults] setInteger:1 forKey:cprocessing_optionNo]; // 640*480
