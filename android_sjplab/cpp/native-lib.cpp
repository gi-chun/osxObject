...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_ConvertToGray(JNIEnv*, jobject, jlong Source, jlong Target)
{
    Mat& im_rgb  = *(Mat*)Source;
    Mat& im_target = *(Mat*)Target;
    cvtColor(im_rgb, im_target, COLOR_BGRA2GRAY);
}

jstring
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
    std::string hello = "Hello from C++";
    return env->NewStringUTF(hello.c_str());
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_nativeDetectAndDisplay(
        JNIEnv *env,
        jobject,
        jlong addrMat) {
    if (cascade.empty()) {
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_OpenTLD(JNIEnv*, jobject, jlong addrGray, jlong addrRgba,
                                                          jlong x, jlong y, jlong width, jlong height)
{
...
jintArray Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_getRect(JNIEnv *env, jobject)
{
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_ProcessTLD(JNIEnv*, jobject, jlong addrGray, jlong addrRgba)
{
    Mat& mRgb = *(Mat*)addrRgba;
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_OpenCMT(JNIEnv*, jobject, jlong addrGray, jlong addrRgba, jlong x, jlong y, jlong width, jlong height)
{
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_ProcessCMT(JNIEnv*, jobject, jlong addrGray, jlong addrRgba)
{
    if (!CMTinitiated)
        return;
    //Mat& img  = *(Mat*)addrRgba;
...
jintArray
Java_com_sjp_sjplab_sjplabandroidot_VideoActivity_CMTgetRect(JNIEnv *env, jobject)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_ConvertToGray(JNIEnv*, jobject, jlong Source, jlong Target)
{
    Mat& im_rgb  = *(Mat*)Source;
    Mat& im_target = *(Mat*)Target;
    cvtColor(im_rgb, im_target, COLOR_BGRA2GRAY);
...
jstring
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
    std::string hello = "Hello from C++";
    return env->NewStringUTF(hello.c_str());
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_nativeDetectAndDisplay(
        JNIEnv *env,
        jobject,
        jlong addrMat) {
    if (cascade.empty()) {
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_OpenTLD(JNIEnv*, jobject, jlong addrGray, jlong addrRgba,
                                                          jlong x, jlong y, jlong width, jlong height)
{
...
jintArray Java_com_sjp_sjplab_sjplabandroidot_VideoRender_getRect(JNIEnv *env, jobject)
{
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_ProcessTLD(JNIEnv*, jobject, jlong addrGray, jlong addrRgba)
{
    Mat& mRgb = *(Mat*)addrRgba;
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_OpenCMT(JNIEnv*, jobject, jlong addrGray, jlong addrRgba, jlong x, jlong y, jlong width, jlong height)
{
...
void
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_ProcessCMT(JNIEnv*, jobject, jlong addrGray, jlong addrRgba)
{
    if (!CMTinitiated)
        return;
    //Mat& img  = *(Mat*)addrRgba;
...
jintArray
Java_com_sjp_sjplab_sjplabandroidot_VideoRender_CMTgetRect(JNIEnv *env, jobject)
{
