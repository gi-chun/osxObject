...
/**
 * Created by gclee on 2016-11-29.
 */
...
public class SplashActivity extends Activity {
    ...
    // Splash screen timer
    private static int SPLASH_TIME_OUT = 5000; //20000
...
private void setAnimation() {
        ObjectAnimator scaleXAnimation = ObjectAnimator.ofFloat(findViewById(R.id.welcome_text), "scaleX", 2.0F, 1.0F); //5.0F
        scaleXAnimation.setInterpolator(new AccelerateDecelerateInterpolator());
        scaleXAnimation.setDuration(1200);
        ObjectAnimator scaleYAnimation = ObjectAnimator.ofFloat(findViewById(R.id.welcome_text), "scaleY", 2.0F, 1.0F);
        ...
        animatorSet.setStartDelay(500); //500
        animatorSet.start();
